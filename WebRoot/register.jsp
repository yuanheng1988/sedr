...
<form action="register" name="registerForm" method="POST" onSubmit="return validateRegister()">
	<table class="shareTable">
		<tr><td colspan="2" ><font color="#FF0000">Register('*' items are necessary)</font></td></tr>
		<tr>
		...
		<tr>
			...
			<td align="left">
				<select size="1" name="title"  style="width:135px">
		...
		<tr>
			...
			<td align="left">
				<select name="country" size="1" style="width:135px">
...
<option value="ZW">Zimbabwe</option>
        ...
        <tr>
        <td></td>
        <td><input type="submit" value="Register" class="input5"  />&nbsp;&nbsp;&nbsp;<input type="reset" value="Reset" class="input5" /></td>
        </tr>
	</table>
